...
const migration = {
    ...
    up: (db) => {
        ...
        logger_1.Logger.info('Migration', `SQLite version: ${sqliteVersion}, can use DROP COLUMN: ${canUseDropColumn}`);
      ...
      `);
        logger_1.Logger.info('Migration', 'Successfully simplified comments table (version 4)');
    },
    down: (db) => {
        // Don't start a transaction - the migration system already handles transactions
        ...
        CREATE INDEX IF NOT EXISTS idx_comments_ticket_id ON comments(ticket_id);
      `);
        logger_1.Logger.info('Migration', 'Successfully rolled back comments table simplification (version 4)');
    },
};
/**
...
//# sourceMappingURL=004-simplify-comments.js.map