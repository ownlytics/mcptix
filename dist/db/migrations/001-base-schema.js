...
const migration = {
    ...
    `);
        logger_1.Logger.info('Migration', 'Applied base schema (version 1)');
    },
    down: (db) => {
    ...
    `);
        logger_1.Logger.info('Migration', 'Rolled back base schema (version 1)');
    },
};
exports.default = migration;
//# sourceMappingURL=001-base-schema.js.map